...
ssh.exec_command('ifconfig em0 inet 192.168.219.123 delete')
...
ssh.exec_command('kldload -n carp')
ssh.close()
print('...')
...
ssh2.exec_command('ifconfig em0 inet 192.168.219.123 delete')
...
ssh2.exec_command('kldload -n carp')
ssh2.close()
print('...')