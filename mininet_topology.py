...
def start_controllers():
    os.system("python3 ryu_start_controllers.py")


def stop_controllers():
    os.system("python3 ryu_stop_controllers.py")


def init_controllers():
    os.system("nohup python3 ryu_init_controllers.py &")
